	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<div class="contact100-form-title"
				...
				<span class="contact100-form-title-1"> Contact Us </span> <span
					class="contact100-form-title-2"> Feel free to drop us a line
					below! </span>
			</div>
			...
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100 validate-input"
					...
					<span class="label-input100">Email:</span> <input class="input100"
						type="text" name="email" placeholder="Enter email addess">
